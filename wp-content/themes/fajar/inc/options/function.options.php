...
$this->sections[] = array(
    ...
    'fields' => array(
        array(
            ...
            'line-height' => false,
            'text-align' => false,
            'output'  => array('#yeah-header-menu.header-fixed #zo-header-navigation .main-navigation .menu-main-menu > li > a',
                '#yeah-header-menu.header-fixed #zo-header-navigation .main-navigation .menu-main-menu > ul > li > a'),
            'units' => 'px',
            'default' => array(
                'font-size' => '12px',
            )
        ...
        array(
            ...
            'line-height' => false,
            'text-align' => false,
            'output'  => array('#yeah-header-menu.header-fixed #zo-header-navigation .main-navigation .menu-main-menu > li ul li a',
                '#yeah-header-menu.header-fixed #zo-header-navigation .main-navigation .menu-main-menu > ul > li ul li a '),
            'units' => 'px',
            'default' => array(
                'font-size' => '12px',
            )
        ...
        array(
            ...
            'line-height' => false,
            'text-align' => false,
            'output'  => array('#yeah-header-menu.zo-main-header.header-fixed .menu-main-menu > li > a i'),
            'units' => 'px',
            'default' => array(
                'font-size' => '12px',
            )
...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'validate' => 'no_html',
            'default' => '.museo_slab_300, #yeah-header-menu .menu-main-menu > ul > li > a',
            'required' => array(
                0 => 'local-fonts-2',
                1 => '!=',
                2 => ''
