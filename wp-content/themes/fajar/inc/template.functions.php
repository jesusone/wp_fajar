...
function zo_social_share() {
    ...
    <ul class="social-list">
        ...
        <li class="box pinterest"><a href="https://www.pinterest.com/pin/create/extension/?url=<?php echo get_the_permalink(); ?>&media=<?php echo esc_url(wp_get_attachment_image_src( get_post_thumbnail_id(get_the_ID()), 'full' ))?>" onclick="javascript:void window.open(this.href,'','width=600,height=300,resizable=true,left=200px,top=200px');return false;"><?php esc_html_e('Pinterest','fajar');?></a></li>
    </ul>
<?php
}
